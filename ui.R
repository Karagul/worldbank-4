  ...
  dashboardSidebar(
    ...
    sidebarMenu(
      ...
      tags$body(
        ...
        a(class="addpad",href="https://twitter.com/kurai26", target="_blank",img(src="images/twitterImage25pc.jpg")),

        a(class="addpad2",href="mailto:dani.nhliziyo@gmail.com", img(src="images/email25pc.jpg")),

        a(class="addpad2",href="https://github.com/kurai26",target="_blank",img(src="images/GitHub-Mark30px.png")),

        a(href="https://rpubs.com/kurai26",target="_blank",img(src="images/RPubs25px.png"))
